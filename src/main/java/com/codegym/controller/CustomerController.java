...
public class CustomerController {
    ...
    @GetMapping("findAllCustomerByFirstName")
    public ResponseEntity<Iterable<Customer>> findAllCustomerByfirstName(@RequestParam("customer") String customer) {
        Iterable<Customer> customers = customerService.findAllByFirstNameContains(customer);
        if (customers == null) {
    ...
    @RequestMapping(value = "/delete-customers/{id}", method = RequestMethod.DELETE)
